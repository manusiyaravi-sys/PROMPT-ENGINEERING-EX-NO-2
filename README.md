...
![P2](https://github.com/user-attachments/assets/ed0b03b4-bcbd-487b-9a19-5a961956cc43)


## RESULT
```
The experiment was conducted to evaluate and compare different prompting techniques such as zero-shot prompting, few-shot prompting, chain-of-thought prompting, and role-based prompting across various AI platforms including ChatGPT, Gemini and Copilot for the task of text summarization.
From the observations, it was found that zero-shot prompting produced quick summaries but sometimes lacked depth and missed important details from the original text. Few-shot prompting performed better because the examples provided in the prompt helped the AI understand the expected format and style of the summary.
Chain-of-thought prompting generated more structured summaries by breaking down the information step by step before presenting the final summary. This improved clarity and logical flow, especially when the input text was complex.
Role-based prompting also produced good results. When the AI was assigned roles such as teacher, journalist, or editor, the summaries became more focused and well-organized according to the perspective of the assigned role.
Among the AI platforms tested, ChatGPT produced more coherent and detailed summaries, while Gemini and Copilot also performed well but occasionally generated shorter summaries.
Overall, the results show that few-shot and chain-of-thought prompting techniques provide more accurate and structured summaries compared to zero-shot prompting, while role-based prompting improves the style and clarity of the summary. Therefore, choosing the appropriate prompting technique can significantly improve the quality of AI-generated text summarization.
```
